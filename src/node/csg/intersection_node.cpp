...
IntersectionNode::IntersectionNode(QObject* parent)
    : Node(parent)
{
    // Nothing to do here
}

IntersectionNode::IntersectionNode(float x, float y, float z, float scale,
                     QObject* parent)
    : Node(NodeManager::manager()->getName("u"), parent)
{
    ...
    new ShapeFunctionDatum("shape", this, "intersection", {"a", "b"});
}
